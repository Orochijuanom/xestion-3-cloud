...
@endif
<form method="POST" action="/cloud/form/12-1/{{$t121->id}}">
{{ csrf_field() }}
{{ method_field('PUT') }}
...
<table cellspacing="0" border="0">
	...
	<tr>
		<td style="border-top: 3px double #000000; border-bottom: 3px double #000000; border-left: 3px double #000000; border-right: 1px solid #000000" colspan=1 rowspan=3 height="127" align="center" valign=middle><b><img style="width:200px; heigth:200px;" src="/images/{{$t121->empresa->logo}}" /></b></td>
		<td style="border-top: 3px double #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan=12 rowspan=2 align="center" valign=middle><b>{{$t121->empresa->nombre_empresa}}<input type="hidden" value="{{$t121->empresa->id}}" name="empresa_id" /><br></b></td>
		...
		<td style="border-top: 3px double #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan=2 align="left" valign=middle><b>Código: <input class="codigo" placeholder="codigo" type="text" required name="codigo" value="{{$t121->codigo}}"></b></td>
		</tr>
	<tr>
		...
		<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan=2 align="left" valign=middle><b>Versión: <input class="codigo" placeholder="version" type="text" required name="version" value="{{$t121->version}}"></b></td>
		</tr>
	<tr>
		...
		<td style="border-top: 1px solid #000000; border-bottom: 3px double #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan=2 align="left" valign=middle><b>Fecha: <input class="codigo" placeholder="fecha" type="date" required name="fecha" value="{{$t121->fecha}}"></b></td>
		</tr>
	<tr>
			...
			<select id="cargo" class="form-control" name="t12_id">
				@foreach ($t12s as $t12)
					@foreach($t12->t12Detalles as $detalle)
                        @if ($detalle->id == $t121->t12_id)
				
                           <option value="{{$t12->id}}" selected>{{$detalle->capacitacion}}</option>
                        @else
	...
	@foreach($t121->t12_1Detalles as $t121Detalle)
	<tr>
