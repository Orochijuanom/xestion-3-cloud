...
<table align="left" cellspacing="0" border="0">
	...
	<tr>
		...
		@elseif($g == 7)
		@endif
		<input type="hidden" value="{{$g}}"  name="numero_grafico[{{$g}}]" /></font></b></td>
	</tr>
	<tr>
		<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan=32 align="center" valign=middle bgcolor="#50b308"><b><font size=3><textarea class="campo" placeholder="NOMBRE DE LA GRAFICA" name="nombre_grafico[{{$g}}]" ></textarea></font></b></td>
	</tr>
	<tr>
