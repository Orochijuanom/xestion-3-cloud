...
<body>
<a href="/cloud/form/l1">Inicio</a> / <a href="/cloud/form/t7/{{$t7->empresa->id}}">t7</a> / <a href="#">Ver editar t7</a>
<br/><br/><br/>
...
<table cellspacing="0" border="0">
	...
	<tr>
		...
		<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 3px double #000000" align="left" valign=middle><b><font face="Arial" size=3>3.2 Version: <input class="codigo" placeholder="version" type="text" required name="version" value="{{$t7->version}}"></font></b></td>
	</tr>
	<tr>
		...
		<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 3px double #000000" align="left" valign=middle><b><font face="Arial" size=3>3.3 Fecha:<input class="codigo" placeholder="fecha" type="date" required name="fecha" value="{{$t7->fecha}}"> </font></b></td>
	</tr>
	<tr>
		<td height="42" align="center" valign=middle bgcolor="#FFFFFF"><font face="Arial" size=3 color="#000000"><br></font></td>
	...
	<tr>
		...
		<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="center" valign=middle bgcolor="#FFFFFF"><font face="Arial" size=3 color="#000000"><textarea class="campo" placeholder=""  name="sede_proyecto[]">{{$detalle->comite}}</textarea><br></font></td>
		<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="center" valign=middle bgcolor="#FFFFFF"><font face="Arial" size=3 color="#000000"><textarea class="campo" placeholder=""  name="fecha_reunion_comite[]">{{$detalle->fecha_reunion_comite}}</textarea><br></font></td>
		<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="justify" valign=middle bgcolor="#FFFFFF"><font face="Arial" size=3 color="#000000"><textarea class="campo" placeholder=""  name="abiertos[]">{{$detalle->abiertos}}</textarea><br></font></td>
		<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="justify" valign=middle bgcolor="#FFFFFF"><font face="Arial" size=3 color="#000000"><textarea class="campo" placeholder=""  name="cerrados[]">{{$detalle->cerrados}}</textarea><br></font></td>
		<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="justify" valign=middle bgcolor="#FFFFFF"><font face="Arial" size=3 color="#000000"><textarea class="campo" placeholder=""  name="fecha_prox_reunion[]">{{$detalle->fecha_prox_reunion}}</textarea><br></font></td>
		<td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 3px double #000000" align="center" valign=middle bgcolor="#FFFFFF" sdnum="1033;1033;M/D/YYYY"><font face="Arial" size=3 color="#000000"><textarea class="campo" placeholder=""  name="evidencia_reunion[]">{{$detalle->evidencia_reunion}}</textarea><br></font></td>
	</tr>	
	@endforeach
</table>
